...
Shell 脚本语言是实现 Linux/UNIX 系统管理及自动化运维所必备的重要工具， Linux/UNIX 系统的底层及基础应用软件的核心大都涉及 Shell 脚本的内容。在 Linux 下，通过编写 Shell 脚本，可以方便，快速，灵活的执行一些系统任务，提升我们开发的工作效率，减少不必要的重复工作。
